...
<head>
    ...
    <link rel="icon" href="https://upload.wikimedia.org/wikipedia/commons/1/10/Flag_of_Scotland.svg" />
...
<body>
    ...
    <video autoplay muted loop class="video-background">
        <source src="img/pop/Edinburgh.mp4" type="video/mp4">
        ...
        <section class="body">
            <div class="ani">
                <br><br><br><br><br><br><br><br><br><br><br><br><br>
                    <a href="princes.php" class="previous round">&#8249;</a>
                    <a href="glasgow.php" class="next round">&#8250;</a>
                <div class="expanded-text">Edinburgh Castle</div>
                <div class="insect2">ปราสาทเอดินบะระ (Edinburgh Castle) ตั้งอยู่บนยอดเขาอาร์เธอร์ ซีท 
                    <br>เป็นสัญลักษณ์ที่ยิ่งใหญ่ของเมืองเอดินบะระและสกอตแลนด์ โครงสร้างที่เก่าแก่และแข็งแกร่งบ่งบอก
                    <br>ถึงประวัติศาสตร์ยาวนานของประเทศ ทิวทัศน์ที่งดงามของเมืองจากด้านบนและความสำคัญทางประวัติศาสต
                    <br>ทำให้มันเป็นสถานที่ที่ไม่ควรพลาดในการเยี่ยมชม</div>
                <p class="insect2">Edinburgh Castle, located atop Arthur's Seat,
                    <br>is a grand symbol of Edinburgh and Scotland. The ancient and sturdy
                    <br>structure speaks volumes about the country's rich history. The spectacular
                    <br>views of the city from the top and its historical significance make it a must-see.</p>
            </section>
