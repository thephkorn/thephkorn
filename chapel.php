...
<body>
    ...
    <video autoplay muted loop class="video-background">
        <source src="img/pop/chapel.mp4" type="video/mp4">
        ...
        <section class="body">
            <div class="ani">
                <br><br><br><br><br><br><br><br><br><br><br><br><br>
                    <a href="matternhorn.php" class="previous round">&#8249;</a>
                    <a href="fraumunster.php" class="next round">&#8250;</a>
                <div class="expanded-text">Chapel Bridge</div>
                <div class="insect2">สะพานชาเปล (Chapel Bridge) มีความงดงามจากโครงสร้างไม้โบราณที่ทอดยาวข้ามแม่น้ำรีอุส 
                    <br>ท่ามกลางวิวทิวทัศน์ของเมืองลูเซิร์นและเทือกเขาแอลป์ ภาพวาดโบราณในสะพานเพิ่มเสน่ห์ให้กับประวัติศาสตร์
                    <br>ที่แฝงอยู่ในแต่ละก้าวของสะพาน ทำให้ที่นี่เป็นสัญลักษณ์ที่สวยงามและน่าหลงใหลของเมืองนี้</div>
                <p class="insect2">Osaka has many beautiful parks and nature, such as Osaka Castle Park where cherry blossoms bloom
                    <br>in spring and the sparkling Osaka River at night. The architecture of this city blends modernity and history,
                    <br>such as Osaka's magnificent castle. Dotonbori is filled with bright lights and neon lights.</p>
            </section>
