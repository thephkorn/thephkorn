...
<head>
    ...
    <link rel="icon" href="https://upload.wikimedia.org/wikipedia/commons/9/9e/Flag_of_Japan.svg"/>
...
<body>
    ...
    <video autoplay muted loop class="video-background">
        <source src="img/pop/fuji.mp4" type="video/mp4">
        ...
        <section class="body">
            <div class="ani">
                <br><br><br><br><br><br><br><br><br><br><br><br><br>
                    <a href="osaka.php" class="previous round">&#8249;</a>
                    <a href="himeji.php" class="next round">&#8250;</a>
                <div class="expanded-text">Fuji</div>
                <div class="insect2">ภูเขาฟูจิ (Mount Fuji) เป็นภูเขาไฟที่สูงที่สุดในญี่ปุ่นและเป็นสัญลักษณ์ที่สำคัญของประเทศ ตั้งอยู่ระหว่างจังหวัดยามานาชิและชิซูโอกะ <br> มีความสูง 3,776 เมตร ฟูจิเป็นที่นิยมในการปีนเขาและเป็นจุดท่องเที่ยวที่สวยงาม โดยเฉพาะในช่วงฤดูร้อนที่นักท่องเที่ยวสามารถขึ้นไปชมวิวที่ยอดเขาได้ <br> ภูเขาฟูจิยังเป็นที่รู้จักในด้านความงามในทุกฤดูกาล โดยเฉพาะในฤดูใบไม้ผลิที่มีดอกซากุระบานรอบๆ และฤดูหนาวที่ยอดเขาปกคลุมไปด้วยหิมะ.</div>
                <p class="insect2">Mount Fuji is the highest mountain in Japan and a symbol of Japan. It is located between Yamanashi Prefecture <br> and Shizuoka Prefecture. Mount Fuji, with an altitude of 3776 meters, is a popular hiking destination, <br> especially during the summer when tourists can climb to the summit. Mount Fuji is famous for its beautiful <br> scenery throughout the four seasons, especially with cherry blossoms blooming in spring and snow covering the summit in winter. </p>
            </section>
